...
\riskprob{100} We will have to deal with it for sure.
\riskimpact{Low - 2} If we don't prevent this risk, the programmers will have to spend time in defining the test plan and the project may be delayed but as we have planned enough time for testing, this shouldn't impact too much in the timing of the project.
\end{risk}
